  ...
  return (
    <label className="block space-y-2">
      ...
      <input
        id={inputId}
        className={cn(
          'min-h-11 w-full rounded-2xl border border-stone-200 bg-white px-4 py-3 text-base text-stone-900 outline-none transition focus:border-[#1f5c5a] focus:ring-2 focus:ring-[#dce9e5]',
